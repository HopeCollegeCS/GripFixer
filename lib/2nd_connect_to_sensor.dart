...
class SecondConnectToSensor extends StatefulWidget {
  const SecondConnectToSensor({super.key});

  @override
  State<SecondConnectToSensor> createState() => _SecondConnectToSensor();
}

class _SecondConnectToSensor extends State<SecondConnectToSensor> {
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () =>
                      context.go("/MatchingPage"), // Call the method
